document.addEventListener("DOMContentLoaded", () => {
    ...
    function hideAllSections() {
      ...
      buttons.forEach((button) => {
        button.style.backgroundColor = "rgb(255, 79, 79)"; // Reset to light blue
        button.style.color = "#E6E6FA"; // Reset font color to black
        button.style.boxShadow = "#800080";
      });
    }
  
    function styleButton(button) {
      button.style.backgroundColor = "rgb(255, 79, 79)"; // Light blue background
      button.style.color = "#E6E6FA"; // Black font color
    ...
    function createButton(button, label, section) {
      ...
      button.addEventListener("click", () => {
        ...
        button.style.backgroundColor = "#FF69B4"; // White background when active
        button.style.color = "#E6E6FA"; // Black font when active
        button.style.justifyContent = 'center';
      });
